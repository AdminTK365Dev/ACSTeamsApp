(function () {
  ...
  microsoftTeams.getContext(function (context) {
      logDebug("checking context...");

      if (context) {
          logDebug("context!");
          var threadIdDiv = document.getElementById('chatId');
          var meetingIdDiv = document.getElementById('meetingId');

          threadIdDiv.innerText = context.chatId;
          meetingIdDiv.innerText = context.meetingId;
      }
      else {
          logDebug("no context");
      }
  ...
  // Logic to let the user configure what they want to see in the tab being loaded
    ...
    if (tabChoice) {
      tabChoice.onchange = function () {
        ...
        microsoftTeams.settings.setValidityState(selectedTab === 'account' || selectedTab === 'chats');
